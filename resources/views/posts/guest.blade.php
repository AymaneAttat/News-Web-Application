...
@endif
	@forelse ($posts as $post)
		<div class="p-8 bg-gray-50 dark:bg-gray-900 flex items-center justify-center max-w-96">
			<div class="px-8 py-4 bg-white dark:bg-gray-800 shadow rounded-lg max-w-lg">
			<div class="flex mb-4">
			...
			<div class="bg-indigo-300 ...">
				<img class="object-cover h-48 w-screen" src="https://images.unsplash.com/photo-1585829365295-ab7cd400c167?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=870&q=80">
			</div>
